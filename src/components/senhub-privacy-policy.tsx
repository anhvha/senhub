      ...
      <div className='container max-w-5xl mx-auto px-4 flex flex-col gap-6'>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className='text-lg text-muted-foreground'>
            ...
            analytics, Google Analytics, or other similar third-party services.
            To learn more about how Google Analytics collects and uses your data
            when you use this site, and how you can control the information sent
            to Google Analytics, please review
            https://www.google.com/policies/privacy/partners. We use these log
            files and analytics to improve and administer our site, to analyze
            trends, and to gather information about our user base.
          </p>
        </div>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className='text-lg text-muted-foreground'>
            ...
            make the Service better for our Members and Visitors. We may ask
            advertisers or other partners to serve ads or services to computers,
            mobile phones, or other devices, which may use a cookie, pixel, or
            other similar technology placed by us or the third party.
          </p>
        </div>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className='text-lg text-muted-foreground'>
            ...
            changes. For members of our VIP Seller Program, Service-related
            announcements also include email messages related to rate changes
            and VIP Seller Program membership expiration. These Service-related
            announcements are considered a fundamental part of the Service;
            Members cannot opt out of these email announcements.
          </p>
        </div>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className='text-lg text-muted-foreground'>
            ...
            the footer of each such email you receive. If you are a Member of
            the Service, you can also see and modify this information in the
            “Account” section of your Member account.
          </p>
        </div>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className='text-lg text-muted-foreground'>
            We may use your information in connection with other websites,
            services, and entities that are under our common ownership or common
            corporate control. We may combine information you provide while
            using the Service with information you provide to other websites,
            services, and entities that are under our common ownership or common
            corporate control.
          </p>
        </div>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className='text-lg text-muted-foreground'>
            ...
            anonymous, non-personal, aggregate statistics that we believe our
            Members and Visitors are interested in viewing. For example, we may
            track and publish the total number of Buyers who have ordered a
            specific shirt color or style. We publish this data in aggregate
            form only, and do not publish any personally identifiable
            information in connection with this use.
          </p>
        </div>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className='text-lg text-muted-foreground'>
            If you place an order from a Seller who is or becomes a member of
            our VIP Seller Program, we will share your email address with the
            Seller. This allows Buyers and Sellers to directly connect, and
            helps Sellers gain valuable feedback from our community and promote
            their upcoming projects and Campaigns.
          </p>
        </div>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className='text-lg text-muted-foreground'>
            Except as provided herein, we will neither rent nor sell your
            personally identifiable information to any other third party not
            under our common ownership or common corporate control. For example,
            if you purchase a Product from Seller who is or becomes a member of
            our Seller Program, we will share your email address with the seller
            from whom your purchase was made. Occasionally we share aggregate
            information about our Members and Visitors with partners or
            advertisers, and we may publish these aggregate usage statistics on
            our website for the interest of our users.
          </p>
        </div>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className='text-lg text-muted-foreground'>
            ...
            through our Service. For example, we may allow you to share
            Campaigns using Facebook and Twitter, among other services, which
            requires that you open accounts on those services themselves. We
            also allow you to pay for Products purchased through the Service
            using our selected third party payment-processing provider. In such
            cases, those services may choose to collect your personal
            information as they deem appropriate. As noted above, we are neither
            responsible for nor in control of how third parties collect, use, or
            disclose information obtained through these linked services. We
            encourage you to be aware when using these third-party services and
            to review their policies before submitting any personal information
            to them.
          </p>
        </div>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <p className='text-lg text-muted-foreground'>
              These vendors may anonymize and aggregate data collected from you
              and use that data for purposes of improving their product or
              providing services to us or other clients.
            </p>
          </div>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <p className='text-lg text-muted-foreground'>
              ...
              sale of some or all of our assets, including bankruptcy, our
              assets, including Member account information and personally
              identifiable information, may be transferred to a third party. At
              that time, your Member account information and personally
              identifiable information may become subject to that third-party’s
              privacy policy.
            </p>
          </div>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <p className='text-lg text-muted-foreground'>
              Both we and our partners maintain standard physical and electronic
              procedural safeguards that limit access to your personally
              identifiable information and other data to employees (or people
              working on our behalf and under confidentiality agreements) who,
              through the course of standard business activities or provision of
              the Service, need to access your personally identifiable
          ...
          <div className='flex flex-col gap-4'>
            ...
            <p className='text-lg text-muted-foreground'>
              If you subscribe to an optional promotional communication through
              the Service, you will be able to unsubscribe via a link in the
              footer of each such email you receive. If you are a Member of the
              Service, you can also see and modify your email subscription
              information in the “Account” section of your Member account.
            </p>
          </div>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <p className='text-lg text-muted-foreground'>
              ...
              contact us by email at privacy@senhub.com.
            </p>
          </div>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <div className='flex flex-col gap-2'>
              <p className='text-lg text-muted-foreground'>
                ...
                your agreement to abide and be bound by it. The most recent
                version of our privacy policy is always available from a link on
                our homepage.
              </p>
              <p className='text-lg text-muted-foreground'>
                If you have any questions about this privacy policy, the
                practices of the Service, or your dealings with the Service,
                please contact us at this email address: privacy@senhub.com
              </p>
            </div>
          </div>
        </div>
